...
local function promote_admin(receiver, member_username, user_id) 
  ...
  if data[group]['moderators'][tostring(user_id)] then 
    return send_large_msg(receiver, member_username..' 🎀🎖عــزيـزي المــطور 😻 هـذا العـظو هوا 🙃 من ضـمن الادمنيـةة 😽 سـورس فلاش@G0vip') 
  end 
...
local function promote2(receiver, member_username, user_id) 
  ...
  if data[group]['moderators'][tostring(user_id)] then 
    return send_large_msg(receiver, member_username..'  🎀🎖عــزيـزي المــطور 😻 هـذا العـظو هوا 🙃 من ضـمن الادمنيـةة 😽 سـورس فلاش هنا @G0vip) 
  end 
  data[group]['moderators'][tostring(user_id)] = member_tag_username 
  save_data(_config.moderation.data, data) 
  send_large_msg(receiver, member_username..'   🎀🎖عــزيزي المـطور 😻 لقـد قـمت بتـرفيع هـذا العـظو الـي رتبـةة ادمن 😽سـورس فلاش هنـا @G0vip') 
end 
...
local function demote2(receiver, member_username, user_id) 
  ...
  if not data[group]['moderators'][tostring(user_id)] then 
     return send_large_msg(receiver, member_username..'  🎀🎖عــزيزي المــطور 😻 تــم تنـزيلةة من الادمنيـةة 😹 سـورس فلاش هنا @G0vip') 
  end 
  data[group]['moderators'][tostring(user_id)] = nil 
  save_data(_config.moderation.data, data) 
  send_large_msg(receiver, member_username..'   🎀🎖عــزيزي المــطور 😻 تــم تنـزيلةة من الادمنيـةة 😹 سـورس فلاش هنا @G0vip) 
end 
...
local function modlist(msg) 
  ...
  if next(data[tostring(msg.to.id)]['moderators']) == nil then 
    return '🎀🎖لا يـوجد 😹 ادمنيـةة 😽 سورس فلاش@G0vip'
  end 
  local i = 1 
...
function get_message_callback(extra, success, result) 
    ...
    elseif get_cmd == "رفع اداري" then 
        ...
        if result.from.username then 
            text = "@"..result.from.username.."   🎀🎖عــزيزي المــطور 😻 لقـد تــم رفعـةة في الاداره 😽 سـورس فلاش هنـا @G0vip" 
        else 
            text = "[ "..user_id.." ]   🎀🎖عــزيزي المــطور 😻 لقـد تــم رفعـةة في الاداره 😽 سورس فلاش هنـا @G0vip" 
        end 
    ...
    elseif get_cmd == "تنزيل اداري" then 
        ...
        if result.from.username then 
            text = "@"..result.from.username.." 🎀🎖عــزيزي المـطـور 😻تـم تنـزيلـةة مـن الادارة 😽 سـورس فلاش هنـا @G0vip" 
        else 
    ...
    elseif get_cmd == "رفع المدير" then 
        ...
        local channel_id = 'channel#id'..result.to.peer_id 
            ...
            if result.from.username then 
                text = "@"..result.from.username.." [ "..result.from.peer_id.." ]   🎀🎖عـزيزي المـطور 😻 لقـد قمت بترفيعه الي رتبه المـدير 😽 سورس فلاش@G0vip" 
            else 
                text = "[ "..result.from.peer_id.." ]   🎀🎖عـزيزي المـطور 😻 لقـد قمت بترفيعه الي رتبه المـدير 😽 سـورس فلاش @G0vip" 
            end 
            send_large_msg(channel_id, text) 
        end 
...
local function cb_user_info(extra, success, result) 
    ...
    if get_cmd == "تنزيل اداري" then 
        ...
        if result.username then 
            text = "@"..result.username.."   🎀🎖عــزيزي المـطور 😻تم تنــزيله من الاداره 😽 سـورس فلاش @G0vip" 
            send_large_msg(receiver, text) 
        else 
